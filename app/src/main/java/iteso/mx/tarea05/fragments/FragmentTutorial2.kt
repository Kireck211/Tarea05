...
class FragmentTutorial2 : Fragment(), AnkoLogger {
    ...
    override fun onCreateView(
        ...
        mPrevious = view.find(R.id.fragment_tutorial_2_btn_previous)
        mNext = view.find(R.id.fragment_tutorial_2_btn_next)
        mPrevious.setOnClickListener { listener.onPrevious(1) }
        mNext.setOnClickListener { listener.onNext(1) }
        return view
    }
}